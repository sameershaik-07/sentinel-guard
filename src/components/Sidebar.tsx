        ...
        <div className="flex items-center gap-4">
          ...
          >
            ...
            <span className="relative flex h-2 w-2 flex-shrink-0 ml-1">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full opacity-60" md-style={{ background: "var(--green-400)" }} style={{ background: "var(--green-400)" }} />
